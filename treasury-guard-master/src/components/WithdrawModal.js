...
const WithdrawModal=({open, closeModal})=>{
    if (!open) return null;
  return (
    <div className='modalBackground'>
        <div className='modalContainer' style={{position:'relative', alignItems:'center', textAlign:'center'}}>
            ...
            <h1 className='text-lg'>Withdraw ETH</h1>
            <Divider />
            ...
            <Divider/>
            <button style={{width:'40%', backgroundColor:'#607ADD', color:'white', height:40, right: 25, position:'absolute', bottom: 25}}>Confirm Withdrawal</button>
        </div>
    </div>
  )
}                                                                   
